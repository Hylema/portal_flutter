...
//  static final DateFormat _fullDayFormat = new DateFormat("EEE MMM dd, yyyy", 'ru');
  static final DateFormat _fullDayFormat = new DateFormat("dd MMMM, EEEE");
  ...
  static List<DateTime> daysInMonth(DateTime month) {
    final DateTime firstDayOfCurrentMont = firstDayOfMonth(month);
    final DateTime lastDayOfCurrentMont = lastDayOfMonth(month);

    var daysBefore = firstDayOfCurrentMont.weekday;
    var firstToDisplay = firstDayOfCurrentMont.subtract(new Duration(days: daysBefore));

    var daysAfter = 7 - lastDayOfCurrentMont.weekday;
    var lastToDisplay = lastDayOfCurrentMont.add(new Duration(days: daysAfter));

    return daysInRange(firstToDisplay, lastToDisplay).toList();
  }

  static List<DateTime> daysInWeek(DateTime month) {
    final DateTime firstDayOfCurrentWeek = firstDayOfWeek(month);
    final DateTime lastDayOfCurrentWeek = lastDayOfWeek(month);
    return daysInRange(firstDayOfCurrentWeek, lastDayOfCurrentWeek).toList();
  }
...
//    return firstDayOfWeek(date).add(new Duration(days: 7));
//  }

//  List<DateTime> daysInMonth(DateTime selectedDay) {
//    var first = firstDayOfMonth(selectedDay);
...
//
//
//    var last = lastDayOfMonth(selectedDay);
//
