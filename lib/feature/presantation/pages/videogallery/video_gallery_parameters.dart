...
class VideoGalleryParameters extends StatefulWidget {

  @override
  VideoGalleryParametersState createState() => VideoGalleryParametersState();
}
...
class VideoGalleryParametersState extends State<VideoGalleryParameters> {
...
//      currentTime: DateTime.now(),
  ...
  _checkFields(){
    if(_videoName.text != '' || _date.text != '' || _periodFrom.text != '' || _periodBy.text != '')
      disable = false;
    else disable = true;
                          ...
                          children: [
                            TextField(
                              ...
                              decoration: InputDecoration(
                                  labelText: "Название ролика",
                                  suffixIcon: _videoName.text.length > 0
                                      ? IconButton(
                                    onPressed: () {
                                      setState(() {
                                        _videoName.clear();
